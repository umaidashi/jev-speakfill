...
- ③ Jev 1 往復目 → c0→色 (0.99), c1→素材 (0.86), c2→ブランド (0.98)
- ③ Jev 2 往復目 → c0_color→赤 (1.00), c1_material→革 (0.92)
- ④ gate → apply 色=赤, 素材=革, ブランド=ルイヴィトン
- 期待 → 色=赤, 素材=革, ブランド=ルイヴィトン
...
- ③ Jev 2 往復目 → c0_color→青 (1.00), c1_material→革 (0.98)
...
- ① segment → [{"text":"東京都在住の女性"}]
- ② context → chunks [{"text":"東京都在住の女性"}]
- ③ Jev 1 往復目 → c0→都道府県 (0.62)
- ③ Jev 2 往復目 → c0_pref→東京都 (0.88)
- ④ gate → apply 都道府県=東京都
- 期待 → 都道府県=東京都, 性別=女性
...
- ③ Jev 1 往復目 → c0→none (0.99), c1→none (1.00)
- ④ gate → apply (なし)
- 期待 → (なし)
