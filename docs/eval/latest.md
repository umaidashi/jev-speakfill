...
- ③ Jev 1 往復目 → c0→ブランド (1.00), c1→ライン・モデル名 (0.99), c2→カテゴリ (0.98), c3→色 (0.99) [6118+723 tok]
...
- ③ Jev 1 往復目 → c0→ブランド (1.00), c1→ライン・モデル名 (0.98), c2→カテゴリ (0.99), c3→色 (1.00) [6118+723 tok]
...
- ③ Jev 1 往復目 → c0→ブランド (0.98), c1→ライン・モデル名 (0.97), c2→素材 (0.99), c3→色 (0.98) [6118+723 tok]
- ③ Jev 2 往復目 → c0_brand→Bottega Veneta (0.99), c2_material→レザー (1.00), c3_color→黒 (0.98) [2697+481 tok]
...
- ③ Jev 1 往復目 → c0→ブランド (1.00), c1→ライン・モデル名 (0.99), c2→素材 (0.99), c3→状態ランク (1.00) [6120+723 tok]
- ③ Jev 2 往復目 → c0_brand→CHANEL (1.00), c2_material→レザー (0.95), c3_cond→A（未使用に近い） (0.70) [2713+485 tok]
...
- ③ Jev 1 往復目 → c0→ブランド (0.99), c1→ライン・モデル名 (1.00), c2→素材 (0.96) [4962+543 tok]
- ③ Jev 2 往復目 → c0_brand→HERMÈS (0.99), c2_material→レザー (0.86) [2359+354 tok]
...
- ③ Jev 1 往復目 → c0→ブランド (0.97), c1→素材 (1.00), c2→色 (0.99), c3→状態ランク (0.99) [6120+723 tok]
- ③ Jev 2 往復目 → c0_brand→Saint Laurent (0.99), c1_material→キャンバス (0.98), c2_color→ベージュ (0.99), c3_cond→D（傷や汚れあり） (0.89) [3038+617 tok]
...
- ③ Jev 1 往復目 → c0→状態ランク (0.92) [2652+183 tok]
- ③ Jev 2 往復目 → c0_cond→none (0.61) [1848+128 tok]
- ④ gate → apply (なし)
- 期待 → (なし)
...
- ③ Jev 1 往復目 → c0→箱 (0.99), c1→保存袋 (0.99) [3853+366 tok]
...
- ③ Jev 1 往復目 → c0→幅 (cm) (1.00), c1→高さ (cm) (1.00), c2→仕入れ値 (1.00), c3→販売価格 (1.00) [6269+723 tok]
...
- ③ Jev 1 往復目 → c0→シリアル・製造番号 (1.00) [2698+183 tok]
...
- ③ Jev 1 往復目 → c0→仕入日 (1.00) [2685+183 tok]
...
- ③ Jev 1 往復目 → c0→色 (1.00), c1→素材 (0.99), c2→ブランド (0.99) [5038+543 tok]
- ③ Jev 2 往復目 → c0_color→赤 (1.00), c1_material→レザー (0.99), c2_brand→Louis Vuitton (0.99) [2760+480 tok]
...
- ③ Jev 1 往復目 → c0→none (0.99), c1→none (0.99) [3813+363 tok]
- ④ gate → apply (なし)
- 期待 → (なし)
...
- ③ Jev 1 往復目 → c0→氏名 (0.99), c1→氏名 (0.99), c2→電話番号 (0.99), c3→都道府県 (0.99) [6163+723 tok]
...
- ③ Jev 1 往復目 → c0→郵便番号 (0.99) [2691+183 tok]
...
- ③ Jev 1 往復目 → c0→ブランド (1.00), c1→ライン・モデル名 (1.00), c2→素材 (0.97), c3→金具の色 (1.00) [6155+723 tok]
- ③ Jev 2 往復目 → c0_brand→HERMÈS (0.99), c2_material→レザー (0.84), c3_hardware→ゴールド (0.99) [2637+442 tok]
...
- ③ Jev 1 往復目 → c0→金具の色 (1.00), c1→色 (0.38), c2→色 (0.99), c3→状態ランク (0.99) [6193+723 tok]
- ③ Jev 2 往復目 → c0_hardware→シルバー (1.00), c2_color→黒 (0.99), c3_cond→A（未使用に近い） (0.97) [2513+350 tok]
...
- ③ Jev 1 往復目 → c0→状態ランク (1.00) [2689+183 tok]
...
- ③ Jev 1 往復目 → c0→状態ランク (0.98), c1→状態ランク (0.91), c2→状態ランク (0.94), c3→金具の色 (1.00) [6220+723 tok]
- ③ Jev 2 往復目 → c0_cond→S（新品・未使用） (0.96), c1_cond→S（新品・未使用） (0.25), c2_cond→S（新品・未使用） (0.65), c3_hardware→ピンクゴールド (1.00) [2893+493 tok]
...
- ③ Jev 1 往復目 → c0→ブランド (1.00), c1→ライン・モデル名 (0.98), c2→ライン・モデル名 (0.99), c3→カテゴリ (0.99) [6116+723 tok]
...
- ③ Jev 1 往復目 → c0→ブランド (0.99), c1→ライン・モデル名 (0.98) [3805+363 tok]
- ③ Jev 2 往復目 → c0_brand→Chloé (0.98) [2073+257 tok]
...
- ③ Jev 1 往復目 → c0→ブランド (1.00), c1→カテゴリ (0.99) [3808+363 tok]
- ③ Jev 2 往復目 → c0_brand→kate spade new york (0.99), c1_category→トートバッグ (0.99) [2410+390 tok]
...
- ③ Jev 1 往復目 → c0→幅 (cm) (1.00), c1→高さ (cm) (1.00), c2→マチ (cm) (0.99) [5063+543 tok]
...
- ③ Jev 1 往復目 → c0→幅 (cm) (1.00), c1→高さ (cm) (1.00), c2→マチ (cm) (1.00) [5070+543 tok]
...
- ③ Jev 1 往復目 → c0→高さ (cm) (0.99) [2649+183 tok]
- ④ gate → apply (なし)
- 期待 → (なし)
...
- ③ Jev 1 往復目 → c0→仕入れ値 (0.99) [2685+183 tok]
...
- ③ Jev 1 往復目 → c0→幅 (cm) (0.99), c1→高さ (cm) (1.00), c2→マチ (cm) (0.68), c3→マチ (cm) (0.83) [6187+723 tok]
...
- ③ Jev 1 往復目 → c0→仕入日 (0.99) [2682+183 tok]
- ④ gate → apply 仕入日=2026-09-24
- 期待 → 仕入日=2026-09-24

**一致 66/66**、Jev トークン 入力 172165 / 出力 19934
