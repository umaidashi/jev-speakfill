# eval 結果 (2026-09-25T08:49)

欄: 氏名 / 電話番号 / メールアドレス / 都道府県[東京都/大阪府/北海道/福岡県] / 性別[男性/女性] / 色[赤/青/黒/白] / 素材[革/布/金属] / ブランド / 購入日 / 受取時間 / 価格 / 発売月 / 重量
...
- ③ Jev 2 往復目 → c0_color→青 (0.99), c1_material→革 (1.00)
...
- ③ Jev 1 往復目 → c0→色 (0.99), c1→素材 (0.98), c2→ブランド (1.00)
...
- ③ Jev 1 往復目 → c0→氏名 (0.94), c1→氏名 (0.97)
- ④ gate → apply 氏名=山田 太郎
- 期待 → 氏名=山田 太郎
...
- ③ Jev 1 往復目 → c0→都道府県 (0.96), c1→都道府県 (0.91), c2→都道府県 (0.59), c3→性別 (1.00)
- ③ Jev 2 往復目 → c0_pref→東京都 (0.91), c1_pref→東京都 (0.61), c2_pref→none (0.64), c3_sex→女性 (0.99)
...
- ③ Jev 1 往復目 → c0→none (0.99), c1→none (0.98), c2→none (0.97), c3→none (0.98)
- ④ gate → apply (なし)
- 期待 → (なし)
...
- ③ Jev 1 往復目 → c0→色 (1.00), c1→素材 (0.96), c2→ブランド (0.99)
- ③ Jev 2 往復目 → c0_color→赤 (1.00), c1_material→革 (1.00)
- ④ gate → apply 色=赤, 素材=革, ブランド=ルイヴィトン
- 期待 → 色=赤, 素材=革, ブランド=ルイヴィトン
...
- ③ Jev 1 往復目 → c0→色 (1.00), c1→素材 (0.98), c2→ブランド (0.99), c3→none (0.74)
- ③ Jev 2 往復目 → c0_color→黒 (1.00), c1_material→金属 (0.99)
- ④ gate → apply 色=黒, 素材=金属, ブランド=エルメス
- 期待 → 色=黒, 素材=金属, ブランド=エルメス
...
- ③ Jev 1 往復目 → c0→色 (1.00), c1→素材 (0.99), c2→ブランド (0.99), c3→none (0.54)
...
- ③ Jev 1 往復目 → c0→色 (1.00), c1→素材 (0.99), c2→ブランド (1.00), c3→購入日 (0.96)
- ③ Jev 2 往復目 → c0_color→赤 (1.00), c1_material→革 (1.00)
...
- ③ Jev 1 往復目 → c0→発売月 (0.93), c1→発売月 (0.97)
