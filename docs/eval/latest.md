...
- ③ Jev 1 往復目 → c0→ブランド (1.00), c1→ライン・モデル名 (0.99), c2→カテゴリ (0.98), c3→色 (1.00)
...
- ③ Jev 1 往復目 → c0→ブランド (0.99), c1→ライン・モデル名 (0.98), c2→カテゴリ (0.99), c3→色 (0.99)
- ③ Jev 2 往復目 → c0_brand→Louis Vuitton (0.99), c2_category→ショルダーバッグ (1.00), c3_color→茶 (0.98)
...
- ③ Jev 1 往復目 → c0→ブランド (0.98), c1→ライン・モデル名 (0.96), c2→素材 (0.99), c3→色 (0.98)
...
- ③ Jev 1 往復目 → c0→ブランド (1.00), c1→ライン・モデル名 (0.99), c2→素材 (0.99), c3→状態ランク (1.00)
- ③ Jev 2 往復目 → c0_brand→CHANEL (1.00), c2_material→レザー (0.94), c3_cond→A（未使用に近い） (0.72)
...
- ③ Jev 1 往復目 → c0→ブランド (0.99), c1→ライン・モデル名 (1.00), c2→素材 (0.96)
- ③ Jev 2 往復目 → c0_brand→HERMÈS (0.99), c2_material→レザー (0.83)
...
- ③ Jev 1 往復目 → c0→ブランド (0.98), c1→素材 (0.99), c2→色 (0.99), c3→状態ランク (0.99)
- ③ Jev 2 往復目 → c0_brand→Saint Laurent (0.98), c1_material→キャンバス (0.99), c2_color→ベージュ (0.98), c3_cond→D（傷や汚れあり） (0.88)
...
- ③ Jev 1 往復目 → c0→状態ランク (0.89)
- ③ Jev 2 往復目 → c0_cond→none (0.67)
- ④ gate → apply (なし)
- 期待 → (なし)
...
- ③ Jev 1 往復目 → c0→箱 (0.99), c1→保存袋 (0.98)
...
- ③ Jev 2 往復目 → c0_color→赤 (1.00), c1_material→レザー (0.99), c2_brand→Louis Vuitton (1.00)
...
- ③ Jev 1 往復目 → c0→氏名 (1.00), c1→氏名 (0.99), c2→電話番号 (0.99), c3→都道府県 (0.99)
...
- ③ Jev 1 往復目 → c0→ブランド (1.00), c1→ライン・モデル名 (1.00), c2→素材 (0.96), c3→金具の色 (1.00)
- ③ Jev 2 往復目 → c0_brand→HERMÈS (0.99), c2_material→レザー (0.88), c3_hardware→ゴールド (0.99)
...
- ③ Jev 1 往復目 → c0→金具の色 (1.00), c1→色 (0.46), c2→色 (0.99), c3→状態ランク (0.99)
- ③ Jev 2 往復目 → c0_hardware→シルバー (1.00), c2_color→黒 (0.99), c3_cond→A（未使用に近い） (0.98)
...
- ③ Jev 2 往復目 → c0_cond→B（目立った傷や汚れなし） (0.98)
...
- ③ Jev 2 往復目 → c0_cond→S（新品・未使用） (0.96), c1_cond→S（新品・未使用） (0.26), c2_cond→S（新品・未使用） (0.70), c3_hardware→ピンクゴールド (1.00)
...
- ③ Jev 1 往復目 → c0→ブランド (1.00), c1→ライン・モデル名 (0.98), c2→ライン・モデル名 (0.98), c3→カテゴリ (0.99)
...
- ③ Jev 1 往復目 → c0→幅 (cm) (1.00), c1→高さ (cm) (1.00), c2→マチ (cm) (0.99)
...
- ③ Jev 1 往復目 → c0→幅 (cm) (1.00), c1→高さ (cm) (1.00), c2→マチ (cm) (1.00)
...
- ③ Jev 1 往復目 → c0→幅 (cm) (0.99), c1→高さ (cm) (1.00), c2→マチ (cm) (0.68), c3→マチ (cm) (0.91)
