...
- ③ Jev 1 往復目 → c0→ブランド (1.00), c1→ライン・モデル名 (0.99), c2→カテゴリ (1.00), c3→色 (1.00)
...
- ③ Jev 1 往復目 → c0→ブランド (0.99), c1→ライン・モデル名 (0.98), c2→素材 (1.00), c3→色 (0.98)
...
- ③ Jev 2 往復目 → c0_brand→CHANEL (1.00), c2_material→レザー (0.96), c3_cond→A（未使用に近い） (0.75)
...
- ③ Jev 2 往復目 → c0_brand→HERMÈS (0.99), c2_material→レザー (0.88)
...
- ③ Jev 1 往復目 → c0→ブランド (0.99), c1→素材 (1.00), c2→色 (1.00), c3→状態ランク (0.99)
- ③ Jev 2 往復目 → c0_brand→Saint Laurent (0.99), c1_material→キャンバス (0.99), c2_color→ベージュ (0.98), c3_cond→D（傷や汚れあり） (0.88)
...
- ③ Jev 1 往復目 → c0→状態ランク (0.86)
- ③ Jev 2 往復目 → c0_cond→none (0.64)
- ④ gate → apply (なし)
- 期待 → (なし)
...
- ③ Jev 1 往復目 → c0→箱 (1.00), c1→保存袋 (1.00)
...
- ③ Jev 2 往復目 → c0_color→赤 (1.00), c1_material→レザー (0.98), c2_brand→Louis Vuitton (1.00)
...
- ③ Jev 2 往復目 → c0_brand→HERMÈS (1.00), c2_material→レザー (0.89), c3_hardware→ゴールド (0.99)
...
- ③ Jev 1 往復目 → c0→金具の色 (1.00), c1→none (0.39), c2→色 (0.98), c3→状態ランク (0.99)
- ③ Jev 2 往復目 → c0_hardware→シルバー (1.00), c2_color→黒 (0.99), c3_cond→A（未使用に近い） (0.96)
...
- ③ Jev 1 往復目 → c0→状態ランク (0.99), c1→状態ランク (0.93), c2→状態ランク (0.97), c3→金具の色 (1.00)
- ③ Jev 2 往復目 → c0_cond→S（新品・未使用） (0.96), c1_cond→A（未使用に近い） (0.33), c2_cond→S（新品・未使用） (0.68), c3_hardware→ピンクゴールド (1.00)
...
- ③ Jev 1 往復目 → c0→ブランド (1.00), c1→ライン・モデル名 (0.98), c2→ライン・モデル名 (1.00), c3→カテゴリ (1.00)
...
- ③ Jev 1 往復目 → c0→ブランド (0.99), c1→ライン・モデル名 (0.96)
