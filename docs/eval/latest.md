...
- ③ Jev 1 往復目 → c0→ブランド (0.98), c1→ライン・モデル名 (0.96), c2→素材 (0.99), c3→色 (0.97)
...
- ③ Jev 2 往復目 → c0_brand→CHANEL (1.00), c2_material→レザー (0.95), c3_cond→A（未使用に近い） (0.75)
...
- ③ Jev 1 往復目 → c0→ブランド (0.99), c1→素材 (1.00), c2→色 (0.99), c3→状態ランク (0.99)
...
- ③ Jev 1 往復目 → c0→金具の色 (1.00), c1→none (0.28), c2→色 (0.96), c3→状態ランク (0.99)
- ③ Jev 2 往復目 → c0_hardware→シルバー (1.00), c2_color→黒 (0.98), c3_cond→A（未使用に近い） (0.98)
...
- ③ Jev 2 往復目 → c0_cond→S（新品・未使用） (0.96), c1_cond→A（未使用に近い） (0.34), c2_cond→S（新品・未使用） (0.61), c3_hardware→ピンクゴールド (1.00)
...
- ③ Jev 1 往復目 → c0→ブランド (1.00), c1→ライン・モデル名 (0.98), c2→ライン・モデル名 (0.99), c3→カテゴリ (1.00)
...
- ③ Jev 1 往復目 → c0→幅 (cm) (1.00), c1→高さ (cm) (1.00), c2→マチ (cm) (0.60)
