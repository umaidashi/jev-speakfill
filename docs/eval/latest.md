...
- ③ Jev 1 往復目 → c0→色 (0.99), c1→素材 (0.86), c2→ブランド (0.99)
- ③ Jev 2 往復目 → c0_color→赤 (1.00), c1_material→革 (0.97)
- ④ gate → apply 色=赤, 素材=革, ブランド=ルイヴィトン
- 期待 → 色=赤, 素材=革, ブランド=ルイヴィトン
...
- ③ Jev 1 往復目 → c0→都道府県 (0.97), c1→都道府県 (0.90), c2→都道府県 (0.62), c3→性別 (0.99)
- ③ Jev 2 往復目 → c0_pref→東京都 (0.89), c1_pref→東京都 (0.51), c2_pref→none (0.68), c3_sex→女性 (0.99)
...
- ③ Jev 1 往復目 → c0→色 (1.00), c1→素材 (0.98), c2→ブランド (1.00)
- ③ Jev 2 往復目 → c0_color→赤 (1.00), c1_material→革 (1.00)
- ④ gate → apply 色=赤, 素材=革, ブランド=ルイヴィトン
- 期待 → 色=赤, 素材=革, ブランド=ルイヴィトン
...
- ③ Jev 1 往復目 → c0→色 (1.00), c1→素材 (0.99), c2→ブランド (1.00), c3→none (0.74)
- ③ Jev 2 往復目 → c0_color→黒 (1.00), c1_material→金属 (0.99)
- ④ gate → apply 色=黒, 素材=金属, ブランド=エルメス
- 期待 → 色=黒, 素材=金属, ブランド=エルメス
...
- ③ Jev 1 往復目 → c0→色 (0.99), c1→素材 (0.99), c2→ブランド (0.99), c3→none (0.55)
- ③ Jev 2 往復目 → c0_color→青 (0.99), c1_material→革 (0.99)
- ④ gate → apply 色=青, 素材=革, ブランド=シャネル
- 期待 → 色=青, 素材=革, ブランド=シャネル
...
- ③ Jev 1 往復目 → c0→都道府県 (0.99), c1→性別 (0.99), c2→氏名 (1.00)
- ③ Jev 2 往復目 → c0_pref→大阪府 (0.99), c1_sex→男性 (1.00)
...
- ③ Jev 1 往復目 → c0→色 (1.00), c1→素材 (1.00), c2→ブランド (1.00), c3→購入日 (0.94)
- ③ Jev 2 往復目 → c0_color→赤 (1.00), c1_material→革 (1.00)
