...
// HTML の type が無くても、設定の numericLabels に合うラベルは number として扱う（「100円」→ 100）
export const effectiveType = (field: Field, cfg: SpeakfillConfig = DEFAULT_CONFIG) =>
  field.type ?? (matchesAny(cfg.numericLabels, field.label) ? 'number' : undefined)
